...
protea_compacta_current <- raster("Spec/Leucadendron argenteum/Soils_cape_no8/Leucadendron argenteum_current_bin_50.tif")

#Species 2040
protea_compacta_cc_2040 <- raster("Spec/Leucadendron argenteum/Soils_cape_no8/Leucadendron argenteum_cc2040_bin_50.tif")
...
#2070
protea_compacta_cc_2070 <- raster("Spec/Leucadendron argenteum/Soils_cape_no8/Leucadendron argenteum_cc2040_bin_50.tif")
...
tif_cc2070_bin <- mask(tif_cc2070_bin_raw,tif_cc2040_bin)
...
wstcp <- shapefile(paste0("sa_PROVINCE__WESTERN CAPE.shp")) 
country <- wstcp
...
#function for Species current to specified year
# single_species_comparison = function(time1, time2, models, species, current){
# 
#   ############################################################################ ##
#   ## Choose Country                                                          ####
#   ############################################################################ ##
...
#   country = shapefile("sa_PROVINCE__WESTERN CAPE.shp")
# 
#   if (current = T){
...
#   df = model_loop(df, models, species, country, time1 = time1, time2 = time2)
